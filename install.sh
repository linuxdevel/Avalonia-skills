...
printf "    avalonia-pro-max            — beautiful Avalonia UI router (design, themes, motion, a11y)\n"
printf "      └ design-system, themes, components, motion, accessibility,\n"
printf "        layout-patterns, icons-imagery, review-checklist, preview-server\n"
printf "\n"
